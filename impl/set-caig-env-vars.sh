...
export CAIG_AZURE_OPENAI_KEY="xxxxxxxx"

echo 'setting CAIG_AZURE_OPENAI_URL'
export CAIG_AZURE_OPENAI_URL="xxxxxxx"
...
export CAIG_COSMOSDB_NOSQL_ACCT="xxxxxx"
...
export CAIG_COSMOSDB_NOSQL_KEY="xxxxxxx"

echo 'setting CAIG_COSMOSDB_NOSQL_RG'
export CAIG_COSMOSDB_NOSQL_RG="xxxxxxxx"

echo 'setting CAIG_COSMOSDB_NOSQL_URI'
export CAIG_COSMOSDB_NOSQL_URI="xxxxxxxxxx"
...
export CAIG_GRAPH_DUMP_UPON_BUILD="true"
